...
"[project]/src/components/tma/index.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tma$2e$js$2f$sdk$2d$react$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@tma.js/sdk-react/dist/index.js [app-ssr] (ecmascript)");
'use client';
;
;
function TmaSDKProvider({ children }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tma$2e$js$2f$sdk$2d$react$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SDKProvider"], {
        options: {
            cssVars: true,
        ...
        fileName: "[project]/src/components/tma/index.tsx",
        lineNumber: 8,
        columnNumber: 5
    }, this);
}
...
"[project]/node_modules/@tma.js/sdk-react/dist/index.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
var ae = Object.defineProperty, ce = (e, t, s)=>t in e ? ae(e, t, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: s
    }) : e[t] = s, c = (e, t, s)=>ce(e, typeof t != "symbol" ? t + "" : t, s);
function Rt(e, t) {
    let s;
    const n = ()=>{
...
class D {
   ...
   */ on(t, s, n) {
        ...
        return r || this.listeners.set(t, r = []), r.push([
            s,
            n
        ]), this.listenersCount += 1, ()=>this.off(t, s);
    }
    /**
...
class G {
   ...
   */ parse(t) {
        if (!(this.isOptional && t === void 0)) try {
            ...
            throw m(Ct, `Unable to parse value${this.type ? ` as ${this.type}` : ""}`, s);
        }
    }
    optional() {
...
function St(e, t) {
    ...
    for(const n in e){
        ...
        if (!r) continue;
        let i, o;
        if (typeof r == "function" || "parse" in r) i = n, o = typeof r == "function" ? r : r.parse.bind(r);
        else {
            const { type: a } = r;
...
function Tt(e) {
    let t = e;
    if (typeof t == "string" && (t = JSON.parse(t)), typeof t != "object" || t === null || Array.isArray(t)) throw T();
    return t;
}
function v(e, t) {
    return new G((s)=>{
...
function xe() {
    ...
    const [, s] = ot(// Don't forget to remove created handlers.
    Ee, // Add "resize" event listener to make sure, we always have fresh viewport information.
    ...
    tt("message", (n)=>{
        ...
        try {
            ...
            it.error(`An error occurred processing the "${i}" event from the Telegram application.
...
function C(e, t, s) {
    if (typeof s == "string") {
        if (e === "web_app_open_link") {
            if (t === "try_instant_view") return f("6.4", s);
            if (t === "try_browser") return f("7.6", s);
        }
        if (e === "web_app_set_header_color" && t === "color") return f("6.9", s);
        if (e === "web_app_close" && t === "return_back") return f("7.6", s);
    }
    switch(e){
...
function V(e, t, s) {
    let n = {}, r;
    if (!t && !s ? n = {} : t && s ? (n = s, r = t) : t && ("targetOrigin" in t ? n = t : r = t), le("Posting event:", r ? {
        event: e,
        data: r
    } : {
        event: e
    }), at()) return window.parent.postMessage(JSON.stringify({
        eventType: e,
        eventData: r
    }), n.targetOrigin || Ie());
    if (It(window)) {
    ...
    throw m(ge, "Unable to determine current environment and possible way to send event. You are probably trying to use Mini Apps method outside the Telegram application environment.");
}
function ke(e) {
    return (t, s)=>{
        if (!C(t, e)) throw m(de, `Method "${t}" is unsupported in Mini Apps version ${e}`);
        if (L(s) && t === "web_app_set_header_color" && "color" in s && !C(t, "color", e)) throw m(_e, `Parameter "color" of "${t}" method is unsupported in Mini Apps version ${e}`);
        return V(t, s);
    };
}
function qt(e) {
...
async function g(e) {
    let t;
    const s = new Promise((a)=>t = a), { event: n, capture: r, timeout: i } = e, [, o] = ot(// We need to iterate over all tracked events, and create their event listeners.
    (Array.isArray(n) ? n : [
        n
    ]).map((a)=>y(a, (h)=>{
            (!r || (Array.isArray(n) ? r({
...
async function q(e, t, s, n = {}) {
    const { result: r, error: i } = await g({
        ...n,
...
function st(...e) {
    return e.map((t)=>{
        ...
        if (L(t)) return st(Object.entries(t).map((s)=>s[1] && s[0]));
   ...
   */ clone() {
    ...
    set(t, s) {
        Object.entries(typeof t == "string" ? {
            [t]: s
        } : t).reduce((n, [r, i])=>this.state[r] === i || i === void 0 ? n : (this.state[r] = i, this.ee.emit(`change:${r}`, i), !0), !1) && this.ee.emit("change", this.state);
    }
    /**
...
function ut(e, t) {
    return new G((s)=>{
        if (typeof s != "string" && !(s instanceof URLSearchParams)) throw T();
...
function Kt(e) {
    return JSON.stringify(Object.fromEntries(Object.entries(e).map(([t, s])=>[
            Me(t),
            s
        ])));
}
function Ue(e) {
    const { initDataRaw: t, themeParams: s, platform: n, version: r, showSettings: i, startParam: o, botInline: a } = e, h = new URLSearchParams();
...
const je = l("backButton", ({ postEvent: e, version: t, state: s = {
    isVisible: !1
...
const Je = l("biometryManager", async ({ postEvent: e, version: t, state: s })=>new ze({
        ...s || C("web_app_biometry_get_info", t) ? s || await Ke({
            timeout: 1e3
        }) : {
            available: !1,
            accessGranted: !1,
...
const Qe = l("closingBehavior", ({ postEvent: e, state: t = {
...
function yt(e, t) {
    return Object.fromEntries(e.map((s)=>[
            s,
            t
        ]));
}
class ts extends _t {
   ...
   */ async delete(t, s = {}) {
        ...
        n.length && await q("deleteStorageValues", {
            keys: n
   ...
   * @param options - request execution options.
   */ async getKeys(t = {}) {
        return Xe().of(u()).parse(await q("getStorageKeys", {}, this.createRequestId(), {
            ...t,
            postEvent: this.postEvent
        }));
    }
    async get(t, s = {}) {
        ...
        if (!n.length) return yt(n, "");
        const r = await q("getStorageValues", {
            keys: n
        }, this.createRequestId(), {
            ...s,
            postEvent: this.postEvent
...
const es = l(({ createRequestId: e, postEvent: t, version: s })=>new ts(s, e, t));
class ss extends _t {
    constructor(t, s){
        super(t, {
...
const ns = l(({ version: e, postEvent: t })=>new ss(e, t));
class rs {
    constructor(t){
        this.initData = t;
    }
...
const is = l(({ initData: e })=>e ? new rs(e) : void 0);
function mn(e) {
    return $t().parse(e);
}
class os extends $ {
...
const as = l(({ version: e, postEvent: t })=>new os(!1, e, t));
class cs extends ht {
...
const hs = l("mainButton", ({ postEvent: e, themeParams: t, state: s = {
    isVisible: !1,
    isEnabled: !1,
    text: "",
    isLoaderVisible: !1,
...
class ls extends $ {
   ...
   */ async getRequestedContact({ timeout: t = 1e4 } = {}) {
        return ps().parse(await q("getRequestedContact", {}, this.createRequestId(), {
            postEvent: this.postEvent,
            timeout: t
        }));
    }
   ...
   */ sendData(t) {
        const { size: s } = new Blob([
            t
        ]);
        if (!s || s > 4096) throw new Error(`Passed data has incorrect size: ${s}`);
   ...
   */ setHeaderColor(t) {
        this.postEvent("web_app_set_header_color", ct(t) ? {
            color: t
        } : {
            color_key: t
...
const ds = l("miniApp", ({ themeParams: e, botInline: t = !1, state: s = {
...
const ws = l(({ postEvent: e, version: t })=>new gs(!1, t, e));
class fs extends $ {
    constructor(t, s, n){
        super({
            isOpened: t
   ...
   */ get isOpened() {
    ...
    async open(t) {
        ...
        const { text: s, capture: n } = (typeof t == "string" ? {
            text: t
        } : t) || {};
        this.isOpened = !0;
        try {
...
const ms = l(({ version: e, postEvent: t })=>new fs(!1, e, t));
class bs extends pt {
    constructor(t, s, n){
        super({
            isVisible: t
...
const vs = l("settingsButton", ({ version: e, postEvent: t, state: s = {
    isVisible: !1
...
const Es = l("themeParams", ({ themeParams: e, state: t = e, addCleanup: s })=>{
    const n = new ys(t);
    return s(n.listen()), n;
});
function bn(e = {}) {
...
function M(e) {
    return new URL(typeof e == "string" ? e : `${e.pathname || ""}${B(e.search || "", "?")}${B(e.hash || "", "#")}`, "http://a");
}
class Ps extends _t {
    constructor(t, s, n){
        super(t, {
            readTextFromClipboard: "web_app_read_text_from_clipboard"
        }), c(this, "supportsParam"), this.version = t, this.createRequestId = s, this.postEvent = n, this.supportsParam = Yt(t, {
   ...
   */ openTelegramLink(t) {
        ...
        if (s !== "t.me") throw new Error(`URL has not allowed hostname: ${s}. Only "t.me" is allowed`);
   ...
   */ async readTextFromClipboard() {
        const t = this.createRequestId(), { data: s = null } = await g({
...
const Rs = l(({ version: e, postEvent: t, createRequestId: s })=>new Ps(e, s, t));
async function Xt(e = {}) {
    const { is_expanded: t, is_state_stable: s, ...n } = await g({
        ...e,
...
class xs extends dt {
   ...
   */ listen() {
        return y("viewport_changed", (t)=>{
            const { height: s, width: n, is_expanded: r, is_state_stable: i } = t, o = O(s);
            this.set({
                height: o,
                isExpanded: r,
                width: O(n),
...
const Cs = l("viewport", async ({ state: e, platform: t, postEvent: s, addCleanup: n })=>{
    let r = !1, i = 0, o = 0, a = 0;
    if (e) r = e.isExpanded, i = e.height, o = e.width, a = e.stableHeight;
    else if ([
        "macos",
        "tdesktop",
        "unigram",
        ...
        "weba",
        "web"
    ].includes(t)) r = !0, i = window.innerHeight, o = window.innerWidth, a = window.innerHeight;
    else {
        const p = await Xt({
            timeout: 1e3,
            postEvent: s
...
function En(e, t) {
    ...
    const [s, n, r] = [
        ...
        "width",
        "stable-height"
    ].map((p)=>t(p)), i = ()=>P(s, `${e.height}px`), o = ()=>P(n, `${e.width}px`), a = ()=>P(r, `${e.stableHeight}px`), h = [
...
function Ss(e = !0) {
    ...
    if (e) {
        ...
        n.id = "telegram-custom-styles", document.head.appendChild(n), t.push(y("set_custom_style", (r)=>{
            n.innerHTML = r;
        }), ()=>document.head.removeChild(n));
    }
    return V("iframe_ready", {
        reload_supported: !0
    }), s;
}
function Ts() {
...
class Is {
    constructor(t, s, n = V){
        if (c(this, "history"), c(this, "ee", new D()), c(this, "attached", !1), c(this, "back", ()=>this.go(-1)), c(this, "on", this.ee.on.bind(this.ee)), c(this, "off", this.ee.off.bind(this.ee)), this._index = s, this.postEvent = n, t.length === 0) throw m(be, "History should not be empty.");
        if (s < 0 || s >= t.length) throw m(ve, "Index should not be zero and higher or equal than history size.");
   ...
   */ go(t, s) {
        const n = this.index + t, r = Math.min(Math.max(0, n), this.history.length - 1);
...
async function ks() {
    if (window.history.length <= 1 || (window.history.pushState(null, ""), await N(1 - window.history.length))) return;
    let e = await N(-1);
    for(; e;)e = await N(-1);
}
function te(e) {
...
class ee {
    constructor(t, s, { postEvent: n, hashMode: r = "classic", base: i } = {}){
        c(this, "navigator"), c(this, "ee", new D()), c(this, "hashMode"), c(this, "base"), c(this, "attached", !1), c(this, "onPopState", ({ state: o })=>{
            if (o === null) return this.push(this.parsePath(window.location.href));
            o === Et ? window.history.forward() : o === Y && this.back(), o === Z && this.forward();
        }), c(this, "onNavigatorChange", async ({ to: o, from: a, delta: h })=>{
        ...
        }), c(this, "on", this.ee.on.bind(this.ee)), c(this, "off", this.ee.off.bind(this.ee)), this.navigator = new Is(t.map((o)=>Q(o, "/")), s, n), this.navigator.on("change", (o)=>{
...
function Os(e) {
    ...
    let n = U(e.hashMode === null ? t : s.includes("?") ? s.slice(1) : `?${s.slice(1)}`);
    const r = e.base ? te(e.base) : void 0;
    if (r) {
        if (!n.startsWith(r)) throw m(ye, `Path "${n}" expected to be starting with "${r}"`);
        n = n.slice(r.length);
    }
    return new ee([
        n
...
const se = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createContext"])(void 0);
function Ns() {
    const e = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContext"])(se);
    if (!e) throw new Error("useSDK was used outside the SDKProvider.");
    return e;
}
function _(e) {
    function t(n) {
        const r = Ns(), [i, o] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(n ? void 0 : ()=>{
            if (Ts()) throw new Error("Using hooks on the server side, you must explicitly specify ssr = true option");
            return r.use(e);
        });
...
const [Ds, Vs] = _(je), [Tn, An] = d(Ds, Vs), [Bs, Ms] = _(Je), [In, kn] = d(Bs, Ms), [Ls, $s] = _(Qe), [On, qn] = d(Ls, $s), [Hs, Us] = _(es), [Nn, Dn] = d(Hs, Us), [Ws, Gs] = _(ns), [Vn, Bn] = d(Ws, Gs), [js, zs] = _(is), [Mn, Ln] = d(js, zs), [Ks, Js] = _(as), [$n, Hn] = d(Ks, Js), [Fs, Qs] = _(hs), [Un, Wn] = d(Fs, Qs), [Ys, Zs] = _(ds), [Gn, jn] = d(Ys, Zs), [Xs, tn] = _(ws), [zn, Kn] = d(Xs, tn), [en, sn] = _(ms), [Jn, Fn] = d(en, sn), [nn, rn] = _(vs), [Qn, Yn] = d(nn, rn), [on, an] = _(Es), [Zn, Xn] = d(on, an);
function tr(e) {
    const [t, s] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(()=>e ? void 0 : nt());
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        e && s(nt());
    }, []), t;
}
...
function ir({ children: e, acceptCustomStyles: t, debug: s }) {
    const n = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(!0), [r, i] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(/* @__PURE__ */ new Map()), o = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(r), a = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((p)=>{
        n.current && i((S)=>(p && p(S), new Map(S)));
            ...
            use (p, ...S) {
                ...
                let I;
                if (Array.isArray(b) && (I = b[1], b = b[0]), !b) return H({
                    result: b,
                    cleanup: I
                });
                function wt(w) {
                ...
                return b instanceof Promise ? (b.then((w)=>a((k)=>k.set(p, wt(w))), (w)=>a((k)=>k.set(p, {
                            error: w
                        }))), H({})) : H(wt(b));
            }
        }), [
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>(n.current = !0, ()=>{
            n.current = !1;
        ...
        }, []), /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsx"])(se.Provider, {
        value: h,
        children: e
    });
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0c900776._.js.map